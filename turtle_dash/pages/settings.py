            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        dcc.Dropdown(id="light-start-period", options=period_opts, value=on_period, clearable=False, searchable=False, className="period-dropdown"),
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        dcc.Dropdown(id="light-end-period", options=period_opts, value=off_period, clearable=False, searchable=False, className="period-dropdown"),
                    ], className="time-select"),
                ], className="time-field"),
            ], className="time-row"),
